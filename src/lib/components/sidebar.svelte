...
<div class="sidebar flex flex-col justify-start items-between w-55 h-full  rounded-lg border-1 border-(--main-stroke) bg-(--main-cardbg)">
    ...
    <!-- Sidebar Link-->
    <div class="sidebar-link flex flex-col justify-start items-start w-full h-full px-3 py-2 gap-1">
    {#each link as links}
            <button
